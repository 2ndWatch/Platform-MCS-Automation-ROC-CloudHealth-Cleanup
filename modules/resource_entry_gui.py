...
def get_resource_ids_list(client_name, resource_keys, resources_dict, run_date_time, logger):
    ...
    for key in resource_keys:
        ...
        entry = eg.enterbox(f'Enter resource IDs for:'
                            ...
                            f'entry field. If there are no resources to enter, leave the entry field blank and click '
                            f'the <OK> button.',
        ...
        if entry:
            ...
            # Write a file of each resource ID set for backup reference if needed; these files shouldn't be needed by
            # the application.
